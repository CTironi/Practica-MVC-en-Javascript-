        ...
        update: async function(){
                if(this.board.ball.x - this.board.ball.radius < 0 ){
                    ...
                    if(this.board.bars[0].score >= 5){
                        drawText("Jugador 2, gana", canvas.height/2, 200, this.ctx);
                        ...
                        drawText("Jugador 2, llevas " + board.bars[0].score + " puntos", canvas.height/2, 200, this.ctx);
                        this.board.playing = false;
                        await sleep(1000);
                    ...
                    if(this.board.bars[1].score >= 5){
                        drawText("Jugador 1, gana", canvas.height/2, 200, this.ctx);
                        this.board.playing = false;
                        await sleep(3000);
                        if (confirm("Desea volver a jugar?") == true) {
                            location.reload();
                        ...
                        drawText("Jugador 1, llevas " + board.bars[1].score + " puntos", canvas.height/2, 200, this.ctx);
                        this.board.ball.resetBall();
                        this.board.playing = false;    
                        await sleep(1000);
                        this.board.playing = true;  
